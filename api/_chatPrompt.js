...
//  Coach system prompt
//
//  Moved out of src/lib/api/chat.js when chat moved behind the server.
//  The client now ships raw context (goals, logs, sessions) and the
//  prompt is assembled here, so the coaching rules aren't readable in
//  the browser bundle either.
// ─────────────────────────────────────────────

export function buildSystemPrompt({ recentLogs = [], recentSessions = [], goals = {}, name = null }) {
